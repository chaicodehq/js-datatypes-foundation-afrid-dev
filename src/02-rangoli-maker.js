...
const border = repeatPattern("🌸-", 5); 
console.log(`Top Border: ${border}`); 


const currentDesign = "red-yellow-red-yellow";
const pinkTheme = replaceRangoliColor(currentDesign, "red", "pink");
console.log(`New Theme: ${pinkTheme}`); 


const precisionBorder = makeRangoliBorder("=-", 7);
console.log(`Precision Border: ${precisionBorder}`); 
